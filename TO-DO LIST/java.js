...
function getlist() {
  ...
  for (let i = 0; i < list.length; i++) {
    ...
    // use a ternary operator to add or remove strikethrough based on completed status
          ...
          <div class="card-body">
            <div class="row my-1">
              ...
              <div class="col-sm-2 text-left">
                <button id="complete" onclick="toggleCompletedStatus(${i})"><i class="fa-sharp fa-solid fa-check"></i></button>
              </div>
